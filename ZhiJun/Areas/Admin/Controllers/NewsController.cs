...
namespace ZhiJun.Areas.Admin.Controllers
{
    ...
    public class NewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Title,Abstract,Body,Author,Category_Id")] News news)
        {
            ...
            ViewBag.Category_Id = new SelectList(db.Categories, "Id", "Name", news.Category_Id);
            return View(news);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,Abstract,Body,Author,CreatedDate,Category_Id")] News news)
        {
            if (ModelState.IsValid)
            {
