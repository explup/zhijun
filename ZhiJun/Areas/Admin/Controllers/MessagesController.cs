...
namespace ZhiJun.Areas.Admin.Controllers
{
    public class MessagesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,MessageBody,SenderEmail,SenderName,SenderDate,Processed")] Message message)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,MessageBody,SenderEmail,SenderName,SenderDate,Processed")] Message message)
        {
            if (ModelState.IsValid)
            {
